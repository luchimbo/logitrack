...
export default function ZoneConfig() {
    ...
    const fetchData = async (showLoader = true) => {
        ...
        try {
            const [zonesData, carriersData, portalsData] = await Promise.all([
                api('/zones'),
                api('/carriers'),
                api('/carrier-portals'),
            ]);
    ...
    const handleDeleteCarrier = async (id) => {
        ...
        try {
            ...
            setPortals(prev => { const next = { ...prev }; delete next[id]; return next; });
            if (carrierToDelete) {
    ...
    return (
        <div className="section active">
            ...
            <div className="card mb-lg">
                ...
                {carriers.length > 0 && <div style={{ marginTop: '18px', borderTop: '1px solid var(--border)', paddingTop: '16px' }}>
